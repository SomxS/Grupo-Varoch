...
class CostoPotencial extends App {
    constructor(link, div_modulo) {
        super(link, div_modulo);
    }
    ...
    filterBarCostoPotencial(options) {
        this.createfilterBar({
            parent: "filterBarCostoPotencial",
            data: [
                { opc: 'button', class: 'col-4', text: 'Consultar', onClick: () => this.ls() }
            ],
        });
    }
    ...
    ls() {
        ...
        this.createTable({
            ...
            conf: { datatable: true, pag: 80, fn_datatable:'data_table_export' },
